    ...
    return (
        <div className="row mt-5">
            ...
            <div className="col-12 text-justify">
                ...
                <p>Currently leading the engineering department — collaborating with Product, Support, HR — where I improved product quality by ~70%, reduced security issues by ~60%, ensured 100% of critical customers’ support requests were handled within 2 hours, while achieving an all-time-high eNPS of 8.40 out of 10</p>
